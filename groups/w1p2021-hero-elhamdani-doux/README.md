...
# schéma numérique 
 ...
 https://www.figma.com/file/XrwJZ84uzyaH6Qyw1ODz8hBv/Jeu-HETIC?node-id=12%3A2
...
| État | Le choix du personnage et/ou de ses caractéristiques impacte l'aventure au moins une fois. **Les directions et choix fait aurons un impact en se rapprochant de la victoire ou reussir à se faire renvoyer donc perdre** | oui |
| État | Une décision ou un événement aléatoire survenu pendant l'aventure a un impact sur la suite, au moins une fois. **Les directions et choix fait aurons un impact en se rapprochant de la victoire ou reussir à se faire renvoyer donc perdre** | oui |
| État | Le choix du personnage et/ou ce qu'il s'est passé pendant l'aventure impactent l'écran de fin. **Il y a un chemin à suivre, plus vous serez mauvaise eleve plus le risque de se faire renvoyer est grand. C'est une question de probabilité, qui devient importante sur les choix fais.** | oui |
