...
URL du site : [https://death-line.netlify.com](https://death-line.netlify.com/)
### Groupe
...
| État | Une décision ou un événement aléatoire survenu pendant l'aventure a un impact sur la suite, au moins une fois. **L'id renvoyé sera différents en fonctions des choix.** ' | OUI |
| État | Le choix du personnage et/ou ce qu'il s'est passé pendant l'aventure impactent l'écran de fin. **Echec ou réussite.** | OUI |
