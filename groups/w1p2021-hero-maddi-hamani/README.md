...
URL du site : https://meurtre-au-theatre.netlify.com/
...
| État | Le choix du personnage et/ou de ses caractéristiques impacte l'aventure au moins une fois.  | Non |
| État | Une décision ou un événement aléatoire survenu pendant l'aventure a un impact sur la suite, au moins une fois. **Le choix de notre histoire et de notre scenario ne nous le permet pas** | - |
