...
URL du site : https://hell-scape.netlify.com/
...
PS : LES PHOTOS DU JEUX ET DES ETAPES SONT envoyées dans un fichier zip à Yves par Email avec l'adresse suivante : remi.tiab@hetic.net !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
| Données | Un fichier `data.json` est utilisé pour stocker la structure du jeu | Yves me la passer en data.js afin de detecter les require |
...
| État | Une décision ou un événement aléatoire survenu pendant l'aventure a un impact sur la suite, au moins une fois. **Le joueur doit faire des choses afin d'obtenir une fourche pour pouvoir monter aux étapes suivantes, sans celle ci le joueur ne peut pas** | Oui |
