<template>
  <div>
    ...
    <div v-if="step.id > 2" class="game"> <!--TEMPLATE GAME AFTER STEP 2-->
      ...
      <ul>
        <li v-for="(action, index) in step.actions" :key="index">
          <router-link :to="action.to.toString()">
            ...
            <div v-if="action.arrow === 'right' && arrowRight === true" class="game__arrows game__arrows--right"></div>
      ...
      <img v-on:dblclick="takeItems" v-if="step.itemName === 'Buche' || buche === true" class="itemsTake buche" :src="step.item" alt="Items Playing">
      <div class="menu">
