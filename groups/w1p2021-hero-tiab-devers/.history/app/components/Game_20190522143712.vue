<template>
  <div>
    <div v-if="step.id <= 2" class="firstStep">
      <router-link to="/game/100"><h1 class="firstStep__title firstStep__title--enfer">ENFER</h1>
      <router-link to="/game/100"><h1 class="firstStep__title firstStep__title--paradis">PARADIS</h1></router-link>
    </div>
