      ...
      <div v-if="step.conversation === true && visible === true">
        ...
        <div class="conversation__box">
          ...
          <ul v-if="step.choices && position === 3" class="choices">
            <li v-for="choice in step.choices" @click="selectChoice" class="choice">
              {{ choice }}
            </li>
          </ul>
...
export default {
  ...
  methods: {
    ...
    selectChoice() {
      let propositions = document.querySelectorAll('li.choice')

        // console.log(propositions);

        // if (propositions.li.childNodes.innerText === "Enfer") {
        //   console.log("Enfer");
        // }

        // console.log(this.step.choices);

        for (let choice of this.step.choices) {
      ...
      //   if (proposition.innerText === "Paradis") {
      //     console.log("Paradis");
      //   }     
      // }
    }
