    ...
    <div v-if="step.id > 2" class="game"> <!--TEMPLATE GAME AFTER STEP 2-->
      ...
      <div @dblclick="openInventory" class="inventory">
        ...
        <div class="inventory__list">
          <ul class="items">
            <li v-for="(item, index) in items" :key="index" :item="item" class="item">
              <img @dblclick="useItems" v-if="buche === false" :src="step.item" alt="" class="itemsImg">
              <p class="itemsName">{{ item }}</p>
            </li>
          </ul>
        </div>
      ...
      <img @dblclick="takeItems" v-if="step.itemName === 'Buche'" class="itemsTake buche" :src="step.item" alt="Items Playing">
      <div class="menu">
