  ...
  <transition name="fade" appear> 
    <div v-if="step.conversation === true && visible === true">
      ...
      <div class="conversation__box">
        ...
        <span v-if="step.conversationNext === true && position < 4" @click="next" class="conversation__next">suivant</span>
        <span v-if="step.conversationNext === true && position === 1 " @click="next" class="conversation__previous">precedent</span>
      </div>
    </div>
  </transition> 
...
import nextMessage from '../services/nextMessage';
