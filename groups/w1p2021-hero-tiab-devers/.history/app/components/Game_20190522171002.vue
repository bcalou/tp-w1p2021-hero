    ...
    <div v-if="step.id > 2" class="game"> <!--TEMPLATE GAME AFTER STEP 2-->
      ...
      <div @dblclick="openInventory" class="inventory">
        ...
        <div class="inventory__list">
          <ul class="items">
            <!-- <li v-for="(item, index) in items" :key="index" :item="item" class="item"><img :src="step.item" alt="" class="itemsImg"></li> -->
            <li v-for="(item, index) in items" :key="index" :item="item" class="item"></li>
          </ul>
        </div>
