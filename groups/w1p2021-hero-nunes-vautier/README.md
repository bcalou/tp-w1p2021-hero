...
URL du site : https://kingdom-in-danger.netlify.com/
...
| État | Le choix du personnage et/ou de ses caractéristiques impacte l'aventure au moins une fois. **Le scénario chargé est différent (position de départ, choix possibles)** | Oui |
| État | Une décision ou un événement aléatoire survenu pendant l'aventure a un impact sur la suite, au moins une fois. **Si l'on décide de fermer la porte du chateau trop tôt, on peut se faire tuer lorsque l'on rencontre des survivants de l'attaque.** | Oui |
| État | Le choix du personnage et/ou ce qu'il s'est passé pendant l'aventure impactent l'écran de fin. **** | Oui |
...
![Schéma](https://github.com/edwinvautier/w1p2021-hero-nunes-vautier/blob/master/app/assets/images/Parcoursutilisateur.jpeg)
