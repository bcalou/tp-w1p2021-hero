...
| État | Le choix du personnage et/ou de ses caractéristiques impacte l'aventure au moins une fois. **Le choix rend l'aventure plus ou moins difficile ** | Non |
| État | Une décision ou un événement aléatoire survenu pendant l'aventure a un impact sur la suite, au moins une fois. **Bonues et malus aléatoires** | Oui |
