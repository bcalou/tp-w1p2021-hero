...
| État | Le choix du personnage et/ou de ses caractéristiques impacte l'aventure au moins une fois. **Indiquez ici comment succintement.** | Il éxiste plusieurs poissons de différente tailles, pouvant ou non passer certain obstacles, leurs tailles devient alors un atout oun désavantages selon les obstacles et chemins empruntés|
| État | Une décision ou un événement aléatoire survenu pendant l'aventure a un impact sur la suite, au moins une fois. **Indiquez ici comment succintement.** | Le choix des poissons ouvrent et fermes différente possibilités
